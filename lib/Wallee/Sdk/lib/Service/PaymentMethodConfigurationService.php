...
class PaymentMethodConfigurationService {
	...
	/**
	 * Operation paymentMethodConfigurationCountPost
	 *
	 * count
	 *
	 ...
	 * @return int
	 */
	public function paymentMethodConfigurationCountPost($spaceId, $filter = null) {
		return $this->paymentMethodConfigurationCountPostWithHttpInfo($spaceId, $filter)->getData();
	}

	/**
	 * Operation paymentMethodConfigurationCountPostWithHttpInfo
	 *
	 * count
	 *
	 * @param int $spaceId  (required)
	 ...
	 * @return ApiResponse
	 */
	public function paymentMethodConfigurationCountPostWithHttpInfo($spaceId, $filter = null) {
		// verify the required parameter 'spaceId' is set
		if ($spaceId === null) {
			throw new \InvalidArgumentException('Missing the required parameter $spaceId when calling paymentMethodConfigurationCountPost');
		}
		// header params
		$headerParams = array();
	...
	/**
	 * Operation paymentMethodConfigurationReadGet
	 *
	 * read
	 *
	 * @param int $spaceId  (required)
	 ...
	 */
	public function paymentMethodConfigurationReadGet($spaceId, $id) {
		return $this->paymentMethodConfigurationReadGetWithHttpInfo($spaceId, $id)->getData();
	}

	/**
	 * Operation paymentMethodConfigurationReadGetWithHttpInfo
	 *
	 * read
	 *
	 * @param int $spaceId  (required)
	 ...
	 * @return ApiResponse
	 */
	public function paymentMethodConfigurationReadGetWithHttpInfo($spaceId, $id) {
		// verify the required parameter 'spaceId' is set
		if ($spaceId === null) {
			throw new \InvalidArgumentException('Missing the required parameter $spaceId when calling paymentMethodConfigurationReadGet');
		}
		// verify the required parameter 'id' is set
		if ($id === null) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling paymentMethodConfigurationReadGet');
		}
		// header params
		$headerParams = array();
	...
	/**
	 * Operation paymentMethodConfigurationSearchPost
	 *
	 * search
	 *
	 * @param int $spaceId  (required)
	 ...
	 * @return \Wallee\Sdk\Model\PaymentMethodConfiguration[]
	 */
	public function paymentMethodConfigurationSearchPost($spaceId, $query) {
		return $this->paymentMethodConfigurationSearchPostWithHttpInfo($spaceId, $query)->getData();
	}

	/**
	 * Operation paymentMethodConfigurationSearchPostWithHttpInfo
	 *
	 * search
	 *
	 * @param int $spaceId  (required)
	 ...
	 * @return ApiResponse
	 */
	public function paymentMethodConfigurationSearchPostWithHttpInfo($spaceId, $query) {
		// verify the required parameter 'spaceId' is set
		if ($spaceId === null) {
			throw new \InvalidArgumentException('Missing the required parameter $spaceId when calling paymentMethodConfigurationSearchPost');
		}
		// verify the required parameter 'query' is set
		if ($query === null) {
			throw new \InvalidArgumentException('Missing the required parameter $query when calling paymentMethodConfigurationSearchPost');
		}
		// header params
		$headerParams = array();
		$headerAccept = $this->apiClient->selectHeaderAccept(array('application/json;charset=utf-8'));

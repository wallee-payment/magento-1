...
/**
 * LabelDescriptorGroupService service
 *
 * @category Class
 * @package  Wallee\Sdk
 ...
 */
class LabelDescriptorGroupService {
	...
	public function labelDescriptionGroupServiceAllGetWithHttpInfo() {
		...
		try {
			...
			switch ($e->getCode()) {
				case 200:
					$responseObject = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Wallee\Sdk\Model\LabelDescriptorGroup[]', $e->getResponseHeaders());

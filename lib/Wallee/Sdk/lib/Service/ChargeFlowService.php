...
class ChargeFlowService {
	...
	/**
	 * Operation chargeFlowApplyFlowPost
	 *
	 * applyFlow
	 *
	 ...
	 */
	public function chargeFlowApplyFlowPost($spaceId, $id) {
		return $this->chargeFlowApplyFlowPostWithHttpInfo($spaceId, $id)->getData();
	}

	/**
	 * Operation chargeFlowApplyFlowPostWithHttpInfo
	 *
	 * applyFlow
	 *
	 * @param int $spaceId  (required)
	 ...
	 * @return ApiResponse
	 */
	public function chargeFlowApplyFlowPostWithHttpInfo($spaceId, $id) {
		// verify the required parameter 'spaceId' is set
		if ($spaceId === null) {
			throw new \InvalidArgumentException('Missing the required parameter $spaceId when calling chargeFlowApplyFlowPost');
		}
		// verify the required parameter 'id' is set
		if ($id === null) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling chargeFlowApplyFlowPost');
		}
		// header params
		$headerParams = array();

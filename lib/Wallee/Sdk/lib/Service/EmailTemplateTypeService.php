...
class EmailTemplateTypeService {
	...
	public function emailTemplateTypeAllGetWithHttpInfo() {
		...
		try {
			...
			switch ($e->getCode()) {
				case 200:
					$responseObject = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Wallee\Sdk\Model\EmailTemplateType[]', $e->getResponseHeaders());
	 ...
	 * read
	 *
	 * @param int $id The id of the email template type which should be returned. (required)
	 * @throws \Wallee\Sdk\ApiException
	 * @return \Wallee\Sdk\Model\EmailTemplateType
	 */
